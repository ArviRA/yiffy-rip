...
def final_res(request):
    ...
    #print(i['torrents'])
        ...
        for link in torrent_files:
            torrent = {}
            link['url'] = "https://yts.unblockninja.com/torrent/download/"+link['hash']
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            for i in data:
                ...
                #print(i['slug'])
                send_dict['large_cover_image'] = "https://yts.unblockninja.com/s__img/assets/images/movies/{}/medium-cover.jpg".format(i['slug'].replace("-","_"))
